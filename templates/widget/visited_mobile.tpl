...
<div class="widget show-1200" style="margin-top: 20px;">
    <div class="widget-title">
        <div class="h2s"><a style="font-size: 20px;">Вы смотрели</a></div>
    </div>

    <div class="product-items visited-mobile">
        <!-- BEGIN visited -->
        <div  class="visited-item product-item">
            ...
            <div class="product-image {visited.LABEL}" style="width:130px; height:130px">
            ...
            <div class="actions clearfix" >
                <a href="item/{visited.KEY}" class="button gray view" style="width:62px;">Подробнее</a>
                <div data-price="{visited.PRICE}" class="button pink red {BUTTON_ORDER_CLASS}" style="width:62px;margin-left:4px;" id="{visited.ID}<!-- BEGIN visited.param -->:{visited.param.POS}<!-- END visited.param -->" >{BUTTON_ORDER_TEXT}</div>
            </div>
        </div>
        <!-- END visited -->
    </div>
