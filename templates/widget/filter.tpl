...
<div class="filter w2 border2">
	<div style="width:279px; height:32px; margin: 0px; margin-bottom:10px;"><h2>Фильтр</h2></div>
    ...
    <div class="items" style="margin-top:20px; margin-bottom:25px;">
        <div class="item" style="text-align:left;margin-left:0px;">от <input type="text" name="filter_price_from" size="6" id="price_from" rel="0" style="width:45px; font-size:14px;"/> - до <input type="text" name="filter_price_to" size="6" id="price_to" rel="6000" style="width:45px; font-size:14px;" value="6000"/> {CURRENCY}</div>
