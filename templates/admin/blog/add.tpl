<div class="oEditItem">
    ...
    <tr>
        <td><span>Заголовок: <font color="red">*</font></span></td>
    ...
    <tr>
        ...
        <td>
            <div style="width:80px;float:left;line-height:22px;">blog/note/</div>
            <div class="inputText" style="padding-left:80px;width:320px"><i><b><input type="text" name="key" rel="name"/></b></i></div>
