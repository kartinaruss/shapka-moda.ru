<table id="list">
	...
	<tr id="{product.ID}">
	    ...
	    <td><!-- BEGIN product.picture --><img src="images/product/s/{product.picture.SRC}" alt="" width="100" /><!-- END product.picture --></td>
...
<!-- BEGIN paginator -->
<div class="oPager">
    <!-- BEGIN paginator.first --><a href="admin/product/main/page/{paginator.first.NUM}{URL_POSTFIX}">{paginator.first.NUM}</a><!-- END paginator.first -->
    <!-- BEGIN paginator.separator1 --><ins>...</ins><!-- END paginator.separator1 -->
    <!-- BEGIN paginator.middle1 --><a href="admin/product/main/page/{paginator.middle1.NUM}{URL_POSTFIX}">{paginator.middle1.NUM}</a><!-- END paginator.middle1 -->
    <!-- BEGIN paginator.current --><i>{paginator.current.NUM}</i><!-- END paginator.current -->
    <!-- BEGIN paginator.middle2 --><a href="admin/product/main/page/{paginator.middle2.NUM}{URL_POSTFIX}">{paginator.middle2.NUM}</a><!-- END paginator.middle2 -->
    <!-- BEGIN paginator.separator2 --><ins>...</ins><!-- END paginator.separator2 -->
    <!-- BEGIN paginator.last --><a href="admin/product/main/page/{paginator.last.NUM}{URL_POSTFIX}">{paginator.last.NUM}</a><!-- END paginator.last -->
</div>
<!-- END paginator -->
<input type="hidden" name="currentUrl" value="admin/product/main/page/{CURRENT_PAGE}"/>