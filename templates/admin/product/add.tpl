<div class="oEditItem">
    <form action="admin/product/add/{CATEGORY_ID}" method="post" enctype="multipart/form-data"><div class="oT2"><table><tbody>
        <tr>
	        ...
	        <td>
	            <div class="Picture">
	                ...
	                <div class="changeImage">
	                    <img src="images/product/temp/{picture.KEY}" alt="" title="" width="180" />
