...
<div class="catalog w2 border2">
  <!--  <div class="head">-->
	<div style="width:104%; height:38px; background-color:#eeedee; margin: -4px 0px 0px -14px; padding-top: 4px"><h2>Поиск<img src="./images/iconfoot.png" style="float:right; display:inline-block; margin:1px 10px 0 0;" /></h2></div>
        <div class="description text" style="margin-left:15px;">Найдено товаров: {SEARCH_TOTAL}</div>
