...
<div class="catExt settings oEditor">
    ...
    <table><tbody>
        ...
        <tr>
            ...
            <td class="pictureBlock"><form action="admin/theme/logo/add" method="post">
			    <!-- BEGIN no_img -->
				<div class="addImage">
				    <span class="oFileLink add"><i>Прикрепить</i><input type="file" name="file" size="40" rel="admin/theme/logo/add"/></span>
				</div>
				<!-- END no_img -->
				<!-- BEGIN img -->
				<div class="changeImage">
				    <img src="images/logo/logo.png?rand={RAND}" alt="" title="" style="border:1px solid gray;padding:3px;"/>
				    <span class="oFileLink add"><i>Поменять</i><input type="file" name="file" size="40" rel="admin/theme/logo/add"/></span>
				    <span class="oFileLink delete" rel="admin/theme/logo/delete"><i>Удалить</i></span>
				</div>
				<!-- END img -->
            </form></td>
        </tr>
