...
<div class="helpDescr">Здесь можно создавать баннеры и управлять уже созданными.</div>
<div class=" oEditor">
	<div class="NutManage">
        <div class="oAddList"><a href="admin/pano/resize" class="e add">Добавить баннер</a></div>
        <div class="list oEditor"><!-- INCLUDE admin/pano/table.tpl --></div>
	</div>
</div>
