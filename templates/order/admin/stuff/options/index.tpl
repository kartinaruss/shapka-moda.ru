            ...
            $(this).ajaxSubmit({
                success: function(data) {
                    if (data=='ok') {
                        ...
                        notice('Опции сайта успешно изменены');
                    } else {
...
<div class="helpDescr">В данном разделе вы можете менять опциональные параметры сайта.</div>
<div class="cats">
    <a href="admin/stuff">Параметры сайта</a>
    <span style="background:#ffffff;">Опции</span>
    <a href="admin/stuff/stat">Статистика</a>
</div>
<div class="catExt settings oEditor">
    <form action="admin/stuff/options/settings" method="post">
        <div class="oT2 oEditItem"><!-- INCLUDE admin/stuff/options/settings.tpl --></div>
    </form>
</div>
