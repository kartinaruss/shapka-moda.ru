<table id="list">
    ...
    <tr id="{testimonial.ID}">
        ...
        <td class="iName">{testimonial.NAME}</td>
        <td class="nowrap">{testimonial.PHONE}</td>
        <td>{testimonial.CITY}</td>
        <td>{testimonial.DUTIES}</td>
	    ...
	    <td><!-- BEGIN testimonial.audio --><a href="files/{testimonial.audio.SRC}">audio</a><!-- END testimonial.audio --></td>
