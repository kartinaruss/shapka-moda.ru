<table>
	...
	<tr>
        <td><div class="actions">
            ...
            <a href="admin/order/edit/{order.ID}" class="edit" title="Редактировать"><i>Редактировать</i></a>
            <a href="admin/order/mail/{order.ID}" class="extra" title="Дополнительно"><i>Дополнительно</i></a>
        </div></td>
	    <td class="expand">
        ...
        <td>{order.EMAIL}</td>
        <td>{order.PRODUCT}</td>
        <td style="display:none;">{order.STEP}</td>
