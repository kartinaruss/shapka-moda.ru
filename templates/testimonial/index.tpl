<form action="testimonial" method="post"> 
    ...
    <div class="oT2 successHide"><table><tbody> 
        <tr> 
            <td style="width:20%"><span>ФИО: <font color="red">*</font></span></td> 
            <td> 
                <div class="inputText" style="width:210px;"><i><b><input type="text" name="name" /></b></i></div> 
                <!-- BEGIN error_name --><div class="error">{error_name.MESSAGE}</div><!-- END error_name -->
            </td> 
        </tr> 
        <tr> 
            <td ><span>Телефон: </span></td> 
            <td><div class="inputText" style="width:210px;"><i><b><input type="text" name="phone" id="phone_number" /></b></i></div>
        ...
        <tr> 
            ...
            <td> 
                <div class="inputText" style="width:210px;"><i><b><input type="text" name="city" /></b></i></div> 
        ...
        <tr> 
            ...
            <td> 
                <div class="textarea"  style="width:170px;"><i><b><textarea name="message" cols="25" rows="8" style="height:200px;"></textarea></b></i></div>
        ...
        <tr> 
            <td class="empty">&nbsp;</td> 
            <td><div class="Buttons" style="width:200px;"> 
