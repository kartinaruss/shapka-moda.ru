...
<footer class="site-footer">
    <div class="wrapper">
        <div class="copy">
            ...
            <div class="fl">
                * По данным рекомендаций наших клиентов<br>из открытых источников за 2018-2019 года
            </div>
        ...
        <div class="oplata">
            ...
            <ul>
                <li><a class="icon visa" style="cursor:default" href="javascript://"></a></li>
                <li><a class="icon mastercard" style="cursor:default" href="javascript://"></a></li>
                <li><a class="icon webmoney" style="cursor:default" href="javascript://"></a></li>
                <li><a class="icon yandexmoney" style="cursor:default" href="javascript://"></a></li>
            </ul>
            <p>Вы можете оплатить покупки<br>наличными при получении, <br>либо онлайн.</p>
        </div>
        <div class="soc">
        </div>
        <div class="contacts">
