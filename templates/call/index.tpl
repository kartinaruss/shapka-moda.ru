    ...
    <div class="oT2 successHide"><table><tbody>
        ...
        <tr>
            ...
            <td><div class="Buttons">
                <div class="button red pink send">Позвоните мне</div>
                <div class="button gray cancel">Отмена</div>
            </div></td>
        </tr>
		<tr>
            <td></td>
            <td><div style="font-size: 11px; color: #777777">Нажимая кнопку «Позвоните мне», вы принимаете условия <a href="./oferta" target="_blank" style="color: #777777">Публичной оферты</a></div></td>
        </tr>
    </tbody></table></div>
</form>