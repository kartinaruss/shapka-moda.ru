...
var myWikiSettings = {
    ...
    markupSet: [   
        ...
        {name:'Цитата', openWith:'(!(> |!|>)!)', className:'blockquote'},
        {separator:'---------------' },
        {name:'Заголовок 1-го уровня', openWith:"+ ", className:'h1', placeholder:"Заголовок"},
        {name:'Заголовок 2-го уровня', openWith:"++ ", className:'h2', placeholder:"Заголовок"},
        {name:'Заголовок 3-го уровня', openWith:"+++ ", className:'h3', placeholder:"Заголовок"},
        {separator:'---------------' },
        {name:'Видео', openWith:'\n<html>\n', closeWith:'здесь код видео из ВКонтакта или YouTube\n</html>\n', className:'video'},
        {name:'HTML код', openWith:'\n<html>\n', closeWith:'\n</html>\n', className:'html'}
    ]
}