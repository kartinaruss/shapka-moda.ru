...
class Widget_Theme extends aWidget
{
    function init()
    {
        ...
        $this->tpl->assignVars(array(
            ...
            'BODY_BG_PATTERN' => is_file(DIR_IMAGES.'/background/pattern.png') ? 'background:url(images/background/pattern.png?rand='.$stuff->rand.') top center;' : '',
            ...
            'MENU_BG_COLOR' => $stuff->menu_bg_color ? 'background-color:'.$stuff->menu_bg_color.' !important;' : '',
            ...
            'TEXT_COLOR' => $stuff->text_color ? 'color:'.$stuff->text_color.';' : '',
            ...
            'BLOCK_BG_COLOR' => $stuff->block_bg_color ? 'background-color:'.$stuff->block_bg_color.';' : '',
